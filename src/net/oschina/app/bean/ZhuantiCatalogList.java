 ...
 * @created 2012-3-21
 */
public class ZhuantiCatalogList extends Entity{
	
	private int zhuanticount;
	private List<ZhuantiType> softwaretypelist = new ArrayList<ZhuantiType>();
	
	public static class ZhuantiType implements Serializable {
		public String name;
		public int tag;
	}
