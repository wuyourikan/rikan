...
public class ListViewZhuantiAdapter extends BaseAdapter {
	 ...
	 * @param resource
	 */
	public ListViewZhuantiAdapter(Context context, List<Zhuanti> data,int resource) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		//设置文字和图片
		Zhuanti zhuanti = listItems.get(position);
		String faceURL = zhuanti.getFace();
		...
		listItemView.face.setTag(zhuanti);
		
		listItemView.title.setText(zhuanti.getTitle());
		listItemView.title.setTag(zhuanti);//设置隐藏参数(实体类)
		listItemView.author.setText(zhuanti.getAuthor());
		listItemView.date.setText(StringUtils.friendly_time(zhuanti.getPubDate()));
	...
	private View.OnClickListener faceClickListener = new View.OnClickListener(){
		public void onClick(View v) {
			Zhuanti zhuanti = (Zhuanti)v.getTag();
			UIHelper.showUserCenter(v.getContext(), zhuanti.getAuthorId(), zhuanti.getAuthor());
		}
	};
}